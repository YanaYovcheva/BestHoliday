...
urlpatterns = [
    ...
    path('api/destinations/', views.ListCreateDestinationApiView.as_view(), name='destinations'),
    ...
    path('api/destinations/<int:pk>/', views.RetrieveUpdateDestroyDestinationApiView.as_view(), name='destination-detail'),
